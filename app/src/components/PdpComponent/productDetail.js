...
class productDetail extends React.Component {
	...
	/* render tab data */
	renderTabData() {
		return this.props.productDetail.productDetails.description.map((tabData, index) => {
			this.activeClass = 'active';
			if (index > 0) {
				this.activeClass = '';
			}
	...
	/* render tab content */
	renderTabContent() {
		return this.props.productDetail.productDetails.description.map((data, index) => {
			this.dataClass = '';
			if (index > 0) {
				...
				<div className="product_details">
					...
					<Row>
						...
						<div className="product_img">
							<img className="imgfullwidth" src={`${newMachineUrl}/${store}/${catalog}${this.props.productDetail.productDetails.imagePath}`} />
						</div>
						</Col>
