                            ...
                            <Link className="link" to={routePath2}>
                                ...
                                <div className='prodDetails'>
                                    <div className='details'>
                                        ...
                                        <p className='offerAmount'>
                                            {recoData.recommendationArray[1].discount}% &amp; {recoData.recommendationArray[1].promotionData}
                                        </p>
                                    </div>
                                </div>
                            </Link>
                        ...
                        <figure className='rightThree col-md-12'>
                            <Link className="link" to={routePath3}>
                                ...
                                <div className='details'>
                                    ...
                                    <p className='offerAmount'>
                                        {recoData.recommendationArray[2].discount }% &amp; {recoData.recommendationArray[2].promotionData}
                                    </p>
                                </div>
                            </div>
                            </Link>
