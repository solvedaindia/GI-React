                                        ...
                                        return(
                                            <div className='orderSummary'>
                                                ...
                                                <div className='prodDetails'>
													{!isMobile() && <p className='count'>ITEM({itemIndex+1}/{orderDetails.orderItems.length})</p>}
                                                    {!isMobile() && <p className='count'>SHIPMENT# ({index+1}/{subOrderDetails.shipmentData.length})</p>}
