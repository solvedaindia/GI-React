      ...
      if (shipmentData.length > 1) {
        ...
        return (
          <div className="itemStatus">
            {shipmentData[0].status}
            <br />
            {this.getStatusDate(shipmentData[0], shipmentData[0].status)}
          </div>
        );
      }
    }
    ...
    return (
      <>
        ...
        {orderData.orderItems.map((data, key) => {
          return (
            <div
              ...
              onClick={this.onProductClick.bind(this, data, orderData)}
            >
        ...
        <div className="totalItem">
          ...
          <button
            className="viewOrder"
            onClick={this.onViewOrderClick.bind(this, orderData)}
          >
            View Order
          </button>
        </div>
