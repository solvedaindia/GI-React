...
class Invoice extends React.Component {
  ...
  componentDidMount() {
    ...
    let orderAPI = `${orderListAPI}?` + `pagenumber=1&` + `pagesize=200&`;
      ...
      <div
        ...
        className={
          isMobile()
            ...
            : "container mobileInvoiceContainer"
        }
        style={isMobile() ? { width: "1010px" } : { width: "90%" }}
      >
        <h3 className="value heading" style={{ textAlign: "center" }}>
          TAX INVOICE
        </h3>
        {!!invoiceData && (
          <div
            ...
            style={
              isMobile()
                ? { border: "1", width: "900px", margin: "auto" }
                : { border: "1", width: "824px", margin: "auto" }
            }
          >
            <div
              className="invoiceContainer topsection"
              style={{
                border: "0",
                width: "100%",
                margin: "auto",
            ...
            >
              ...
              <div className="value" style={{ width: "24%", float: "left" }}>
                {invoiceData.salesInvoiceNo}
              </div>
              <div className="value" style={{ width: "4%", float: "left" }}>
                &nbsp;
              </div>
              ...
              >
                ...
                <div className="value">
                  {!!invoiceData.companyAddress &&
                    invoiceData.companyAddress.name}
                </div>
                <div className="value">
                  {!!invoiceData.companyAddress &&
              ...
              >
                ...
                <div className="value">
                  {!!invoiceData.consignorAddress &&
                    invoiceData.consignorAddress.name}
                </div>
                ...
                <div className="value">
                  {!!invoiceData.consignorAddress &&
                    invoiceData.consignorAddress.gstinNo}
                </div>
              </div>
            </div>
            <div
              className="invoiceContainer addresssection customer"
              style={
                isMobile()
                  ? {
                      border: "0",
            ...
            >
              ...
              >
                ...
                <div className="value">
                  {!!invoiceData.billTo && invoiceData.billTo.name}
                </div>
                <div className="value heading">Billing Address</div>
                <div className="value">
                  {!!invoiceData.billTo && invoiceData.billTo.address1}
                </div>
                <div className="value">
                  {!!invoiceData.billTo && invoiceData.billTo.address2}
                </div>
                <div className="value">
                  {!!invoiceData.billTo && invoiceData.billTo.address3}
                </div>

                <div className="value heading">City</div>
                <div className="value">
                  {!!invoiceData.billTo && invoiceData.billTo.city}
                </div>

                <div className="value heading">State</div>
                <div className="value">
                  {!!invoiceData.billTo && invoiceData.billTo.state}
                </div>

                <div className="value heading">Zipcode</div>
                <div className="value">
                  {!!invoiceData.billTo && invoiceData.billTo.zipCode}
                </div>
                <div className="value heading">Contact No</div>
                <div className="value">
                  {!!invoiceData.billTo && invoiceData.billTo.contactNo}
                </div>

                <div className="value heading">GST No (if applicable)</div>
                <div className="value">
                  {!!invoiceData.billTo && invoiceData.billTo.gstinNo}
                </div>
              </div>
              <div
                className="invoiceContainer addresssection"
              ...
              >
                ...
                <div className="value">
                  {!!invoiceData.shipTo && invoiceData.shipTo.name}
                </div>
                <div className="value heading">Delivery Address</div>

                <div className="value">
                  {!!invoiceData.shipTo && invoiceData.shipTo.address1}
                </div>
                <div className="value">
                  {!!invoiceData.shipTo && invoiceData.shipTo.address2}
                </div>
                <div className="value">
                  {!!invoiceData.shipTo && invoiceData.shipTo.address3}
                </div>
                <div className="value heading">City</div>
                <div className="value">
                  {!!invoiceData.shipTo && invoiceData.shipTo.city}
                </div>
                <div className="value heading">State</div>
                <div className="value">
                  {!!invoiceData.shipTo && invoiceData.shipTo.state}
                </div>
                <div className="value heading">Zipcode</div>
                <div className="value">
                  {!!invoiceData.shipTo && invoiceData.shipTo.zipCode}
                </div>
                <div className="value heading">Contact No</div>
                <div className="value">
                  {!!invoiceData.shipTo && invoiceData.shipTo.contactNo}
                </div>
              </div>
            </div>

            <div
              className="invoiceContainer itemsection"
              style={
                isMobile()
                  ? {
                      border: "0",
            ...
            >
              <div
                className="itemsection invoiceheading"
                style={{
                  border: "0",
                  width: "100%",
                  margin: "auto",
              ...
              >
                <div
                  ...
                  style={
                    isMobile()
                      ? { width: "14%", margin: "auto", float: "left" }
                      : { width: "16%", margin: "auto", float: "left" }
                  }
                >
                  Item Id
                </div>
                <div
                  ...
                  style={
                    isMobile()
                      ? { width: "17%", margin: "auto", float: "left" }
                      : { width: "14%", margin: "auto", float: "left" }
                  }
                >
                  {" "}
                ...
                <div
                  ...
                  style={
                    isMobile()
                      ? { width: "14%", margin: "auto", float: "left" }
                      : { width: "12%", margin: "auto", float: "left" }
                  }
                >
                  HSN Code
                </div>
                <div
                  className="value heading"
                  style={{ width: "10%", margin: "auto", float: "left" }}
                >
                  Item Price
                </div>
                <div
                ...
                <div
                  ...
                  style={
                    isMobile()
                      ? { width: "7%", margin: "auto", float: "left" }
                      : { width: "10%", margin: "auto", float: "left" }
                  }
                >
                  SGST{" "}
                </div>
              ...
              {!!invoiceData &&
                invoiceData.lineItemDetails &&
                invoiceData.lineItemDetails.lineItemList.map(
                  (itemList, index) => {
                    return (
                      <div
                        className="itemList"
                      ...
                      >
                        <div
                          style={
                            isMobile()
                              ? { width: "14%", margin: "auto", float: "left" }
                              : { width: "15%", margin: "auto", float: "left" }
                          }
                        >
                          {itemList.itemCode}
                        </div>
                        ...
                        <div
                          style={
                            isMobile()
                              ? { width: "14%", margin: "auto", float: "left" }
                              : { width: "13%", margin: "auto", float: "left" }
                          }
                        >
                          {itemList.hsnCode}
                        </div>
                        ...
                        <div
                          style={
                            isMobile()
                              ? { width: "10%", margin: "auto", float: "left" }
                              : { width: "9%", margin: "auto", float: "left" }
                          }
                        >
                          {itemList.quantity}
                        </div>
              ...
              <div
                className="itemsection invoicefooter"
                style={{
                  border: "0",
                  width: "100%",
              ...
              >
                ...
                <div
                  ...
                  style={
                    isMobile()
                      ? { width: "68%", margin: "auto", float: "left" }
                      : { width: "67%", margin: "auto", float: "left" }
                  }
                >
                  &nbsp;
                </div>
                ...
                >
                  {!!invoiceData.lineItemDetails &&
                    invoiceData.lineItemDetails.totalAmount}
                </div>
              </div>
            </div>
          </div>
      ...
      return (
        <div className="invoiceTicket">
          <div id="content">
            <div
              id="invoiceDiv"
              className="container invoiceContainer"
              style={{ color: "red", margin: "60px", width: "90%" }}
            >
          ...
          <div className={isMobile() ? "invoiceContent" : null} id="content">
            {UserLoggedIn == "true" ? (
              ...
              <div
                ...
                style={{ color: "red", margin: "60px", width: "90%" }}
              >
                Selected invoice is not applicable for you, please login with
                linked user account
              </div>
            )}
          </div>
