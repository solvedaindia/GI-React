      ...
      specs.push(
        <Row className="specifec-detail">
          <Col xs={12} sm={4} md={6} className="attr-details">
            <span className="col-md-5">{att.name}</span>{' '}
            <span className="col-md-7">{att.value}</span>
          </Col>

          <Col xs={12} sm={4} md={4} className="attr-desc">
            {this.props.data.length > 1 ? (
              second_att ? (
                <p>{second_att.value}</p>
              ) : (
                'NA'
              )
            ) : (
  ...
  render() {
    return (
      <div className="compare-product-list">
        ...
        <Row>
          <h2 className="title-text">Delivery</h2>
        </Row>
        <Row className="prod-delivery-slot">{this.renderDelivery()}</Row>
        ...
        <Row>
          <h2 className="title-text">Specifications</h2>
        </Row>
        {this.renderSpecs()}
