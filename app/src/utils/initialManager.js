...
import { guestLoginAPI, storeId, accessToken, accessTokenCookie, wishlistDataCookie, wishListCountApi } from '../../public/constants/constants';
...
export function getUpdatedWishlist() {
    axios
