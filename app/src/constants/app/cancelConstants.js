...
export const MESSAGE_CANCEL = "We are sorry to hear that! Please let us know why you wish to cancel the order."; 
...
export const ERROR_MESSAGE_REASON ="Please chose your reason";
