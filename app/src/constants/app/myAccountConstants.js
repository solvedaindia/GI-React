...
export const REQUIRED_FIELD = 'The field is a required';
export const ENTER_PASSWORD = 'Please enter the Password';
export const INVALID_PASSWORD = 'Invalid Password. Password should not be more than 25 characters';
export const PASSWORD_SHOUBLE_BE = "Password should be within 6-20 characters only. Special characters are not permitted";
export const SIX_CHAR_PASS = 'Invalid Password. Password should have min 6 characters and atleast 1 number';
export const HELLO_GUEST = 'Hello Guest! Please enter your Order Number to track';
export const ORDER_NO = 'Order Number';
export const GO_BACK = 'Go back';
export const VALID_NAME= 'Please enter a valid Name. It should not exceed 100 characters';
...
export const VALID_ADD = 'Please enter valid Address.';
