...
export const EMI_EASY = 'EMI (Easy Installment)';
export const EQUAL_MONTHLY_INSTALLMENT = 'Pay for your order in equal monthly installments (EMI), using any one of the payment options in the table below.';
export const CONVERT_THE_PAYMENT = 'Your bank will convert the payment done using credit or debit cards into EMI in 3-4 working days.';
...
export const DEL_CHARGES = ' Delivery Charges:';
