...
export class MyAccountContainer extends React.Component {
  ...
  componentWillReceiveProps(nextProp) {
    ...
    this.setState({
      redirectedFrom: nextProp.location.state
        ? nextProp.location.state.from
        : null
    });
    // }
  }
        ...
        <ul className="nav nav-tabs">
          ...
          this.state.profileName !== undefined ? (
            <h4 className="username">
              Hello {this.state.profileName.split(" ")[0]}!
            </h4>
          ) : null}
          ...
          <li className="list">
            <a
              onClick={this.onMyProfileClick.bind(this)}
              className={`link ${
                this.state.redirectedFrom === "myprofile" ? "active show" : ""
              }`} /*  href="#profile-v" */ /* data-toggle="tab" */
            >
              My Profile
            </a>
          </li>
          <li className="list">
            <a
              onClick={this.onPasswordClick.bind(this)}
              className={`link ${
                this.state.redirectedFrom === "password" ? "active show" : ""
              }`} /*  href="#changePassword-v" */ /* data-toggle="tab" */
            >
              Change Password
            </a>
          </li>
          <li className="list">
            <a
              onClick={this.onMyServiceRequestClick.bind(this)}
              className={`link ${
                this.state.redirectedFrom === "serviceRequest"
                  ? "active show"
                  : ""
              }`} /*  href="#profile-v" */ /* data-toggle="tab" */
            >
          ...
          <li className="list">
            <a
              onClick={this.onMyOrderClick.bind(this)}
              className={`link ${
                this.state.redirectedFrom === "myorder" ? "active show" : ""
              }`} /* href="#myOrder-v" */ /* data-toggle="tab" */
            >
              My Orders
            </a>
          </li>
          <li className="list">
            <a
              ...
              className={`link ${
                this.state.redirectedFrom === "address" ? "active show" : ""
              }`} /* href="#manageAddresses-v" */ /* data-toggle="tab" */
            >
              Manage Addresses
            </a>
          </li>
          ...
          <li onClick={this.onCustomerCareClick.bind(this)} className="list">
            <a className="link" href="#customercare-v" data-toggle="tab">
              Customer Care
            </a>
          </li>
        </ul>
          ...
          <div className="row">
            ...
            >
              <div className="tab-content">
                <div
                  className={`tab-pane ${
                    this.state.redirectedFrom === "myprofile" ? "active" : ""
                  }`} /*  id="profile-v" */
                >
                  {" "}
                  <MyProfile
                    myProfileCallbackPro={this.myProfileCallback}
                    restrictRefresh={this.state.redirectedFrom}
                  />
                </div>
                <div
                  className={`tab-pane ${
                    this.state.redirectedFrom === "password" ? "active" : ""
                  }`} /*  id="changePassword-v" */
                >
                  <ChangePassword
                    changePasswordTagPro={this.state.changePasswordTag}
                  />
                </div>
                <div
                  className={`tab-pane ${
                ...
                <div
                  className={`tab-pane ${
                    this.state.redirectedFrom === "myorder" ? "active" : ""
                  }`} /*  id="myOrder-v" */
                >
                  {isMobile() ? (
                    <div className="row ongoing-order">
                      <RWDMyOrder
                        isGuestTrackOrderPro={isGuestTrackOrder}
                        guestOrderDataPro={guestOrderData}
                      />
                    </div>
                  ) : (
                    <MyOrder
                ...
                <div
                  className={`tab-pane ${
                    this.state.redirectedFrom === "address" ? "active" : ""
                  }`} /* id="manageAddresses-v" */
                >
                  <ManageAddress />
                </div>
                <div className="tab-pane" id="customercare-v">
                  Customer Care Tab.
                </div>
